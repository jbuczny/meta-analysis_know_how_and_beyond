...
This script was created to simulate power analysis for Pearson's *r*.

It is assumed that 0.1 is small effect size, 0.3 is medium, and 0.5 is
large effect size.

For an additional tutorial visit: <https://mikkelvembye.github.io/POMADE/>
...
rho = correlations between effect sizes
within studies
